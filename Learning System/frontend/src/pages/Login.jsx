...
import { Sparkles, Mail, Lock, Eye, EyeOff, Quote, Target, BarChart2, Zap, Trophy } from 'lucide-react';
import './auth.css';

export default function Login() {
  const { login, loginWithGoogleData } = useContext(AuthContext);
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        const res = loginWithGoogleData(userInfo.data);
        if (res.success) {
          navigate('/practice');
        } else {
          setError(res.error);
    ...
    <div className="auth-page-wrapper">
      ...
      <div className="auth-form-section">
        <div className="auth-form-card">
          ...
          <div className="auth-divider-clean">or sign in with</div>
